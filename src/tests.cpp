...
string alpha_leave_out = "testtest_alpha_leave_out_log.csv";
string alpha_acc = "testtest_alpha_acc_pred_class.csv";
string alpha_opt = "testtest_opt_alphas.csv";
...
namespace {
    ...
    TEST(LeaveOneOut, TestOptimalAlphaSingleClassSingleFile) {
        ...
        string fname = "AmateurBoxer1.csv";
        t2d.run_entity_and_compute_alphas();
        t2d.append_to_file(alpha_leave_out, "=============== TestOptimalAlphaSingleClassSingleFile =============");
        t2d.run_entity_test_left_one_out_class(class_uri, alpha_leave_out);
        ASSERT_EQ(t2d.m_files_alpha.find(fname), t2d.m_files_alpha.cend());
        ...
        ASSERT_EQ(t2d.m_classes_pred_acc[class_uri], -1);
    }
    ...
    TEST(LeaveOneOut, TestOptimalAlphaSingleClassMulti) {
        ...
        t2d.run_entity_and_compute_alphas();
        t2d.append_to_file(alpha_leave_out, "=============== TestOptimalAlphaSingleClassMulti =============");
        t2d.run_entity_test_left_one_out_class(class_uri, alpha_leave_out);
        ASSERT_NE(t2d.m_files_alpha.find(fname), t2d.m_files_alpha.cend());
    ...
    TEST(LeaveOneOut, AbsenceOfOptAlpha) {
        ...
        t2d.append_to_file(alpha_leave_out, "=============== AbsenceOfOptAlpha =============");
        t2d.run_entity_test_left_one_out_all(alpha_leave_out, alpha_opt, alpha_acc);
        ASSERT_NE(t2d.m_classes_pred_acc.find(class_uri), t2d.m_classes_pred_acc.cend());
        ASSERT_EQ(t2d.m_classes_pred_acc[class_uri], -1);
